...
class Spdetails extends StatefulWidget {
  ...
  final SmartPrfessional courseData;

  // Required this CourseData Class in Spdetails 
  const Spdetails({super.key, required this.courseData});

  @override
  _SpdetailsCardState createState() => _SpdetailsCardState();
}

class _SpdetailsCardState extends State<Spdetails> {
            ...
            const SizedBox(height: 8.0),
              ...
              const  Text(
               ...
               const   Text(
                ...
                const SizedBox(height: 8.0),
                  ReadMoreText(
                    widget.courseData.Sdescription,
                    trimLines: 3,
